...
" 	nmap <silent><F2> :up<CR> :!clear && g++ -g --std=c++11 % && echo "> Compiled with Debug info ... "<CR>
" 	nmap <silent><F2> :up<CR> :!clear && make && echo "> Running " && ./a.out<CR>
	nmap <silent><F2> :up<CR> :!clear && make<CR>
" 	nmap <silent><F4> :up<CR> :!qmake-qt4 -project && qmake-qt4 && make && ./app <CR>
" 	nmap <silent><F4> :up<CR> :!qmake-qt4 -project && qmake-qt4 && make && ./${PWD##*/} <CR>
" 	nmap <silent><F4> :up<CR> :!qmake-qt4 -project && qmake-qt4 && make && ./fnamemodify(getcwd(), ':t') <CR>
